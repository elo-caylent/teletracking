...
variable "default_route_destination_attachment" {
  description = "The transit gateway attachment to which the VPN attachments are goint to sent the defaul 0.0.0.0/0 traffic"
  type        = string
}
